...
pheatmap(data,color=scaleyellowred, clustering_method = "complete", clustering_distance_rows="euclidean",clustering_distance_cols="correlation",scale="row",fontsize=12, fontsize_row=12,cellwidth = 10,show_rownames = F, show_colnames = F, border_color=NA,filename = paste(opt$filename,".png",sep=''),main="",width=8,height=6, annotation = anno, annotation_colors = anno_colors) #白血病
}
